        ...
        <div className="container px-5 py-8 mx-auto">
          <div className="flex flex-wrap mark">
            <div className="p-4 md:w-1/3 sm:w-full">
              <div className="flex items-center justify-center h-full">
                <img
                  className="h-24 w-24 object-center rounded-2xl object-contain"
                  src="cellstrat.png"
                  alt="sponsor_logo"
                />
              </div>
            ...
            <div className="p-4 md:w-1/3 sm:w-full">
              <div className="flex items-center justify-center h-full">
                <img
                  className="h-24 w-24 object-center rounded object-cover"
                  src="Sandlogic.png"
                  alt="“SandLogic LOGO”"
                />
              </div>
          ...
          <div className="flex flex-wrap mark">
            <div className="p-4 md:w-1/3 sm:w-full">
              <div className="flex items-center justify-center h-full">
                <img
                  className="h-24 w-24 object-center rounded-2xl object-cover"
                  src="DEVlight.png"
                  alt="“DEVFOLIO LOGO”"
                />
              </div>
